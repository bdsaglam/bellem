...
# %% auto 0
__all__ = ['TextEncoder', 'PromptLearner', 'PromptLearningClip', 'make_prompt_learning_clip', 'prepare_prompt_learning_clip',
           'get_clip_preprocess']
...
def make_prompt_learning_clip(classnames, clip_model_name="ViT-B/32", prec='fp32', **kwargs):
    ...
    return PromptLearningClip(clip_model, tokenizer, classnames, **kwargs)
