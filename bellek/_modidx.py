...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'bellek'},
  'syms': { 'bellek.ml.evaluation': { 'bellek.ml.evaluation.find_binary_clf_threshold': ( 'ml/evaluation.html#find_binary_clf_threshold',
            ...
            'bellek.ml.vision': { 'bellek.ml.vision.Make3Channel': ('vision.html#make3channel', 'bellek/ml/vision.py'),
                                  'bellek.ml.vision.Make3Channel.__call__': ('vision.html#make3channel.__call__', 'bellek/ml/vision.py'),
                                  'bellek.ml.vision.Make3Channel.__repr__': ('vision.html#make3channel.__repr__', 'bellek/ml/vision.py'),
                                  'bellek.ml.vision.TorchVisionTransform': ('vision.html#torchvisiontransform', 'bellek/ml/vision.py'),
                                  'bellek.ml.vision.TorchVisionTransform.__init__': ( 'vision.html#torchvisiontransform.__init__',
                                                                                      'bellek/ml/vision.py'),
                                  'bellek.ml.vision.TorchVisionTransform.encodes': ( 'vision.html#torchvisiontransform.encodes',
                                                                                     'bellek/ml/vision.py')},
            'bellek.testing': {'bellek.testing.get_fixture_path': ('testing.html#get_fixture_path', 'bellek/testing.py')},
