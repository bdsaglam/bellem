  ...
  'syms': { 'bellek.ml.clip': { 'bellek.ml.clip.ClipClassificationHead': ('ml.clip.html#clipclassificationhead', 'bellek/ml/clip.py'),
            ...
            'bellek.ml.data': { 'bellek.ml.data.ZippedDataLoader': ('ml.data.html#zippeddataloader', 'bellek/ml/data.py'),
                                ...
                                'bellek.ml.data.fetch_imagenet_label_synsets': ( 'ml.data.html#fetch_imagenet_label_synsets',
                                                                                 'bellek/ml/data.py'),
                                'bellek.ml.data.get_imagenet_label_map': ('ml.data.html#get_imagenet_label_map', 'bellek/ml/data.py'),
                                'bellek.ml.data.make_imagenet_label_map': ('ml.data.html#make_imagenet_label_map', 'bellek/ml/data.py')},
            'bellek.ml.evaluation': { 'bellek.ml.evaluation.classification_summary': ( 'ml.evaluation.html#classification_summary',
                                      ...
                                      'bellek.ml.evaluation.find_binary_clf_threshold': ( 'ml.evaluation.html#find_binary_clf_threshold',
                                                                                          'bellek/ml/evaluation.py')},
            'bellek.ml.experiment': { 'bellek.ml.experiment.make_experiment_dir': ( 'ml.experiment.html#make_experiment_dir',
                                                                                    'bellek/ml/experiment.py'),
                                      'bellek.ml.experiment.merge_config_with_sweep_config': ( 'ml.experiment.html#merge_config_with_sweep_config',
                                                                                               'bellek/ml/experiment.py'),
            ...
            'bellek.utils': { 'bellek.utils.Path.ls_sorted': ('utils.html#path.ls_sorted', 'bellek/utils.py'),
                              'bellek.utils.Tree': ('utils.html#tree', 'bellek/utils.py'),
                              'bellek.utils.Tree.__init__': ('utils.html#tree.__init__', 'bellek/utils.py'),
                              'bellek.utils.Tree.at': ('utils.html#tree.at', 'bellek/utils.py'),
                              'bellek.utils.Tree.flat': ('utils.html#tree.flat', 'bellek/utils.py'),
                              'bellek.utils.Tree.from_flat_dict': ('utils.html#tree.from_flat_dict', 'bellek/utils.py'),
                              'bellek.utils.Tree.set': ('utils.html#tree.set', 'bellek/utils.py'),
