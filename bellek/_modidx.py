...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'bellek.ml.cocoop': { 'bellek.ml.cocoop.ClipClassificationHead': ( 'ml.cocoop.html#clipclassificationhead',
            ...
            'bellek.ml.data': { 'bellek.ml.data.ZippedDataLoader': ('ml.data.html#zippeddataloader', 'bellek/ml/data.py'),
                                ...
                                'bellek.ml.data.ZippedDataLoader.__next__': ( 'ml.data.html#zippeddataloader.__next__',
                                                                              'bellek/ml/data.py')},
            ...
            'bellek.ml.mcd': {'bellek.ml.mcd.discrepancy': ('ml.mcd.html#discrepancy', 'bellek/ml/mcd.py')},
