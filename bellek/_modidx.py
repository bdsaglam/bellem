...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'bellek'},
  'syms': { 'bellek.ml.cocoop': { 'bellek.ml.cocoop.PromptLearner': ('ml.cocoop.html#promptlearner', 'bellek/ml/cocoop.py'),
                                  ...
                                  'bellek.ml.cocoop.prepare_prompt_learning_clip': ( 'ml.cocoop.html#prepare_prompt_learning_clip',
                                                                                     'bellek/ml/cocoop.py')},
            'bellek.ml.evaluation': { 'bellek.ml.evaluation.find_binary_clf_threshold': ( 'ml.evaluation.html#find_binary_clf_threshold',
