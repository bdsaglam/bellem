...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'bellek.ds': { 'bellek.ds.NestedDict': ('ds.html#nesteddict', 'bellek/ds.py'),
            ...
            'bellek.dspy.module.cte': { 'bellek.dspy.module.cte.ConnectTheEntities': ( 'dspy.module.cte.html#connecttheentities',
                                                                                       'bellek/dspy/module/cte.py'),
                                        'bellek.dspy.module.cte.ConnectTheEntities.__init__': ( 'dspy.module.cte.html#connecttheentities.__init__',
                                                                                                'bellek/dspy/module/cte.py'),
                                        'bellek.dspy.module.cte.ConnectTheEntities.forward': ( 'dspy.module.cte.html#connecttheentities.forward',
                                                                                               'bellek/dspy/module/cte.py'),
                                        'bellek.dspy.module.cte.JERX': ('dspy.module.cte.html#jerx', 'bellek/dspy/module/cte.py'),
                                        'bellek.dspy.module.cte.QA': ('dspy.module.cte.html#qa', 'bellek/dspy/module/cte.py'),
                                        'bellek.dspy.module.cte.validate_number_of_triples': ( 'dspy.module.cte.html#validate_number_of_triples',
                                                                                               'bellek/dspy/module/cte.py'),
                                        'bellek.dspy.module.cte.validate_triple_format': ( 'dspy.module.cte.html#validate_triple_format',
                                                                                           'bellek/dspy/module/cte.py')},
            'bellek.dspy.predict.cte': { 'bellek.dspy.predict.cte.ConnectTheEntities': ( 'dspy.predict.cte.html#connecttheentities',
                                         ...
                                         'bellek.dspy.predict.cte.ConnectTheEntities.forward': ( 'dspy.predict.cte.html#connecttheentities.forward',
                                                                                                 'bellek/dspy/predict/cte.py')},
            'bellek.dspy.utils': {'bellek.dspy.utils.configure_lm': ('dspy.utils.html#configure_lm', 'bellek/dspy/utils.py')},
            ...
            'bellek.mhqa.dspy': { 'bellek.mhqa.dspy.GenerateAnswer': ('mhqa.dspy.html#generateanswer', 'bellek/mhqa/dspy.py'),
                                  'bellek.mhqa.dspy.QAModule': ('mhqa.dspy.html#qamodule', 'bellek/mhqa/dspy.py'),
                                  'bellek.mhqa.dspy.QAModule.__init__': ('mhqa.dspy.html#qamodule.__init__', 'bellek/mhqa/dspy.py'),
                                  'bellek.mhqa.dspy.QAModule.forward': ('mhqa.dspy.html#qamodule.forward', 'bellek/mhqa/dspy.py'),
                                  'bellek.mhqa.dspy.load_qa_func': ('mhqa.dspy.html#load_qa_func', 'bellek/mhqa/dspy.py')},
            'bellek.mhqa.llm': { 'bellek.mhqa.llm.load_qa_func': ('mhqa.llm.html#load_qa_func', 'bellek/mhqa/llm.py'),
                                 'bellek.mhqa.llm.make_qa_func': ('mhqa.llm.html#make_qa_func', 'bellek/mhqa/llm.py')},
            ...
            'bellek.musique.eval': { 'bellek.musique.eval.aggregate_scores': ( 'musique.eval.html#aggregate_scores',
                                     ...
                                     'bellek.musique.eval.compute_scores_dataframe': ( 'musique.eval.html#compute_scores_dataframe',
                                                                                       'bellek/musique/eval.py'),
